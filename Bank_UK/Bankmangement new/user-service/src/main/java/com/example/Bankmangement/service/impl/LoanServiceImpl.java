...
public String approveLoan(long id ,LoanDto loa) {
		...
		loanRepository.save(loan);
		 ...
		 String email=loanRepository.getEmail(id);
			...
			String body=  "Hi  greeting from ****SS BANK****  .Your loan tracking id is  . Your " + loan.getLoanType()+
             " is accepted  successfully . Thank you for choosing our bank . " +loan.getMessage()+ "Thanks and Regrads SS BANK Manger";
			
			SimpleMailMessage message=new SimpleMailMessage();
			message.setFrom("vathalasambasiva@gmail.com");
			message.setTo(email);
